...
const AddSavingsCategory = () => {
  ...
  const onSubmit = (data) => {
    ...
    console.log(data);
    fetch(`http://localhost:8080/categories/savings?category_name=${category_name}&budget_amount=${budget_amount}`, {
      method: 'POST',
      headers: {
...
export default AddSavingsCategory